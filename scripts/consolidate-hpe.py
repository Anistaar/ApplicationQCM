# Script de consolidation HPE
import sys
import os
from pathlib import Path

HPE_DIR = Path("src/questions/S1/HPE")
OUTPUT_FILE = HPE_DIR / "HPE_MEGA_COMPLET.txt"

FILE_TAGS = {
    "HPE_Smith.txt": ["Smith", "AdamSmith", "Classique", "MainInvisible"],
    "HPE_Ricardo.txt": ["Ricardo", "DavidRicardo", "Classique", "AvantagesComparatifs"],
    "HPE_Marx.txt": ["Marx", "KarlMarx", "Marxisme", "PlusValue"],
}
...
def main():
    print("=" * 60)
    print("📚 CONSOLIDATION HPE - CRÉATION DU MEGA FICHIER")
    print("=" * 60)
    print()
    
    header = """# HPE - FICHIER MEGA COMPLET
# Histoire de la Pensée Économique S1
# Total: ~89 questions
